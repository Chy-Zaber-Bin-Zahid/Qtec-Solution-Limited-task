...
function App() {
  return (
    <MyProvider>
      <main className="flex flex-col items-center justify-center h-screen bg-slate-100 relative max-[475px]:px-2">
        <div className="max-w-[50rem] h-full my-4 rounded-md flex flex-col overflow-hidden shadow-[0_3px_10px_rgb(0,0,0,0.2)] min-[800px]:h-[750px] max-[475px]:w-full">
